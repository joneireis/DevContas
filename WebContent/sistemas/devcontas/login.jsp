...
<%  session.removeAttribute("login");
    if (requisita("usuario") != "") {
        try {
            ...
            String sqlpapel = "SELECT U.CD_USUARIO_PORTAL, to_char(U.CD_PAPEL)CD_PAPEL FROM DBACP.USUARIO_PORTAL_PAPEL U "
            ...
            if (rs.next()) {
                ...
                if (rs.getString("VALIDACAO").equals(rs.getString("DS_SENHA"))) {
                   ...
                   while (rs3.next()) {
                    ...
                    session.setAttribute("login", rs.getString("CD_USUARIO_PORTAL"));
...
%>
	    ...
	    <div style="text-align:left;margin-top:-50px;color:#30A5FF; font-family:Verdana; font-size:18px; text-decoration:underline;"></div>
        <div class="row">
            
            <div class="col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
                <div class="login-panel panel panel-default">
                    <div class="panel-heading" style="height: 70px; margin-top: 70px;"><img class="" src='../../img/rede_impar.gif' width='120' height='50' alt='asd'/></div>
